...
class DynamicDropdownWidget(ChoiceWidget):
    class Media:
        ...
        js = ["wagtail_dynamic_dropdown/js/dynamic_dropdown.js"]

    input_type = "radio"
    template_name = "wagtail_dynamic_dropdown/widgets/dynamic_dropdown.html"
    option_template_name = (
        "wagtail_dynamic_dropdown/widgets/dynamic_dropdown_option.html"
    )
    ...
    def __init__(self, attrs=None, dynamic_choices=()):
        ...
        if (
            type(dynamic_choices).__name__ == "function"
            or type(dynamic_choices).__name__ == "method"
        ):
